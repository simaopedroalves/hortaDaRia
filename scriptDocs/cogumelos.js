...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    for (let i = 0; i < object.cogumelos.length; i++) {
        
        let cogumelosName = object.cogumelos[i].name;
        let cogumelosPrice = object.cogumelos[i].price;
        let image = object.cogumelos[i].image;
        let stock = object.cogumelos[i].stock;
        let product_id = object.cogumelos[i].productId;
        ...
        secCogumelos.innerHTML += `
            <div class="boxItem" id="${product_id}">
                <h3 id="itName">${cogumelosName}</h3>
                <img src="${image}" alt="">
