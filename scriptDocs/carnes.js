...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    for (let i = 0; i < object.carnes.length; i++) {
        
        let carnesName = object.carnes[i].name;
        let carnesPrice = object.carnes[i].price;
        let image = object.carnes[i].image;
        let stock = object.carnes[i].stock;
        let product_id = object.carnes[i].productId;
        ...
        secCarnes.innerHTML += `
            <div class="boxItem" id="${product_id}">
                ...
                <select type="text" min="1" class="quantity" placeholder="quantidade">
                    ...
                    <option value="300gr">300 gr.</option>
                </select>
