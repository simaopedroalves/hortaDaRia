...
const secCabazDois = document.querySelector('.cabaz-extra');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // for (let i = 0; i < object.cabazes.length; i++) {
        ...
        let cabazName = object.cabazes[4].name;
        let cabazPrice =  object.cabazes[4].price;
        let cabazContent = object.cabazes[4].content;
